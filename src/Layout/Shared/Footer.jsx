...
const Footer = () => {
    return (
        <footer className="container max-w-7xl mx-auto px-4 divide-y dark:bg-gray-100 dark:text-gray-800 text-white">
            <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">QueryQuotient</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="font-semibold tracking-wide uppercase dark:text-gray-900">Product</h3>
                    ...
                    <div className="space-y-3">
                        <h3 className="font-semibold tracking-wide uppercase dark:text-gray-900">Company</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="font-semibold uppercase dark:text-gray-900">Developers</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <div className="font-semibold uppercase dark:text-gray-900">Social media</div>
